...
public class Swagger2 {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.jnshu.carrots.backstageservice.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .description("更多Spring Boot相关文章请关注：http://localhost:8772/swagger-ui.html")//设置文档的描述->1.Overview
